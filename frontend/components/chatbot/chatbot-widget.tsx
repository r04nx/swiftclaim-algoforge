...
export default function ChatbotWidget() {
  const { isOpen, setIsOpen, isMinimized, setIsMinimized, messages, addMessage } = useChatbot()
  ...
  const toggleListening = () => {
    if (isListening) {
      ...
      setTimeout(() => {
        setInput("I need help filing a health insurance claim")
        setIsListening(false)
      }, 2000)
    }
  }
    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-6 right-6 h-14 w-14 rounded-full bg-gradient-to-r from-[#fa6724] to-[#07a6ec] shadow-lg z-50"
        >
              ...
              <form onSubmit={handleSendMessage} className="p-4 border-t">
                <div className="flex gap-2">
                  <Button
                    ...
                    className={`${isListening ? "text-[#fa6724]" : "text-gray-400"}`}
                  >
